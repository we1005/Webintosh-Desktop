...
export let appMenu = {
    ...
    "壁纸": ["文件", "显示", "窗口", "帮助"],
    "备忘录": ["文件", "编辑", "格式", "显示", "窗口", "帮助"],
    "日历": ["文件", "编辑", "显示", "窗口", "帮助"],
    "通讯录": ["文件", "编辑", "卡片", "显示", "窗口", "帮助"],
    "地图": ["文件", "编辑", "显示", "窗口", "帮助"],
    "GitHub": ["文件", "编辑", "显示", "窗口", "帮助"],
    "LinkedIn": ["文件", "编辑", "显示", "窗口", "帮助"],
    "历程": ["文件", "显示", "窗口", "帮助"],
    "技术栈": ["文件", "显示", "窗口", "帮助"],
    "Google": ["文件", "编辑", "显示", "窗口", "帮助"],
    "音乐播放器": ["文件", "编辑", "歌曲", "显示", "窗口", "帮助"],
    "Music-Player": ["文件", "编辑", "歌曲", "显示", "窗口", "帮助"],
    "Calculator": ["文件", "编辑", "显示", "窗口", "帮助"],
    "VS Code": ["文件", "编辑", "显示", "窗口", "帮助"],
};
let appControl = [
