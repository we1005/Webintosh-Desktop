...
#tit {
    ...
    font-size: 13px;
        ...
        red.addEventListener('mousedown', (event) => { this.start_click(event, 1); });
        yellow.addEventListener('mousedown', this.start_click);
        green.addEventListener('mousedown', this.start_click);
