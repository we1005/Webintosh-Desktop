...
### 🧩 内置应用
访达、终端、文本编辑、虚拟机（FreeDOS）、Spotify、音乐（Apple Music）、计算器、系统设置、关于本机、Safari、泡泡堂

### 🧪 机器学习 / 深度学习套件（启动台启动，需联网加载 CDN 资源）
...
- [机器学习套件](docs/机器学习套件.md) —— Python 实验室 / AI 工具箱 / JupyterLite / 游戏厅的用法、原理、限制与适用场景
